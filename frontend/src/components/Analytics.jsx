              ...
              <div className="simple-chart">
                {analytics.salesTrends.map((item, index) => (
                  <div key={index} className="chart-item">
                    ...
                    <span className="revenue">${item.revenue?.toFixed(2) || '0.00'}</span>
                  </div>
                ))}
              </div>
            ) : (
            ...
            {analytics.revenueByMonth.length > 0 ? (
              analytics.revenueByMonth.map((item, index) => (
                <div key={index} className="revenue-item">
                  ...
                  <span className="amount">${item.revenue?.toFixed(2) || '0.00'}</span>
        ...
        <div className="summary-grid">
          <div className="summary-item">
            ...
            <span className="value">
              ${analytics.salesTrends.reduce((sum, item) => sum + (item.revenue || 0), 0).toFixed(2)}
            </span>
          </div>
          <div className="summary-item">
            <span className="label">Total Orders (Last {timeRange} days)</span>
            <span className="value">
              {analytics.salesTrends.reduce((sum, item) => sum + (item.orders || 0), 0)}
            </span>
          </div>
          <div className="summary-item">
